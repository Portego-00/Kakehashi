...
export const PATCH_NOTES: PatchNote[] = [
  {
    ...
    changes: [
      {
        type: "improvement",
        title: "Optional Jitai Font Cycling",
        description:
          "Cycle through all selected Jitai fonts with a new option in advanced Review Settings. Off by default.",
        link: {
          route: "/settings",
