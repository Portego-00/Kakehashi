...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <AppShellBackActionProvider register={registerPageBackAction}><div className={styles.shell} data-demo={isDemo || undefined} data-lesson-session={pathname === "/lessons" || pathname === "/lesson-picker" || pathname === "/bunpro-reviews" || pathname === "/bunpro-lessons" || undefined} data-workspace={notebookWorkspace ? "notebooks" : undefined}>
    <SettingsApplicator />
