  ...
  return <main className={`page ${styles.page}`}>
    ...
    <section className={styles.settingsSection} aria-labelledby="reviews-heading">
      ...
      <Card padding="none" className={styles.preferenceCard}>
        ...
        <ToggleRow label="Show vocabulary frequency" description="Look up and display the word’s Jiten frequency rank on vocabulary prompts and reader word details." checked={settings.study.showVocabularyFrequency} onChange={(value) => updateStudy("showVocabularyFrequency", value)} />
