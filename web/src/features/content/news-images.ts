...
const NEWS_IMAGE_HOSTS = new Set(["nhkeasier.com", "www.nhkeasier.com", "www3.nhk.or.jp", "www.nhk.or.jp"]);
...
export function normalizeNewsImageUrl(value: string | null | undefined, baseUrl = NEWS_IMAGE_BASE) {
  ...
  try {
    ...
    url.hash = "";
    return NEWS_IMAGE_HOSTS.has(url.hostname.toLocaleLowerCase()) ? url.toString() : undefined;
  } catch {
    return undefined;
  }
}
