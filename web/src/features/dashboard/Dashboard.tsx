...
export function Dashboard() {
  ...
  const sections: Record<string, React.ReactNode> = {
    ...
    "review-heatmap": <section className={styles.section}><SectionHeader title="Review heatmap" detail="Lesson, Guru and burn milestones by day" />{assignments.isLoading ? <Skeleton height="10rem" /> : <ReviewActivityHeatmap days={reviewActivityDays} />}</section>,
