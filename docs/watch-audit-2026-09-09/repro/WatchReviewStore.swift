...
final class WatchReviewStore: NSObject, ObservableObject {
  ...
  private func loadCachedSnapshot() {
    guard let data = UserDefaults(suiteName: "com.kakehashi.audit.20260909.logic")!.data(forKey: cacheKey),
  ...
  private func cache(_ snapshot: ReviewSnapshot) {
    ...
    UserDefaults(suiteName: "com.kakehashi.audit.20260909.logic")!.set(data, forKey: cacheKey)
  }
